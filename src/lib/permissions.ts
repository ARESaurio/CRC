...
const ROUTE_ACCESS: Record<string, DebugRoleId[]> = {
	...
	'/admin/runs':         ['super_admin', 'admin', 'moderator', 'verifier'],
	...
	'/admin/news':         ['super_admin', 'admin'],
	'/admin/reports':      ['super_admin', 'admin', 'moderator'],
	...
	'/admin/rule-suggestions': ['super_admin', 'admin'],
	'/admin/contributions': ['super_admin', 'admin', 'moderator'],
	'/admin/tooltips':      ['super_admin', 'admin'],
};
