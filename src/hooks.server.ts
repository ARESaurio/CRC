...
export const handle: Handle = async ({ event, resolve }) => {
	...
	// _headers only applies to static assets on Cloudflare Pages — SSR responses
	// (generated by the Worker/Function) don't inherit those rules. We set them here
	// so every response gets consistent security headers.
